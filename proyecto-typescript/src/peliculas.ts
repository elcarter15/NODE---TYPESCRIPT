...
import { GeneroPelicula, PaisPelicula, Pelicula } from './interfaces';
...
class CatalogoPeliculas {
    ...
    buscarPorGenero(genero: GeneroPelicula): Pelicula[] {
    ...
    buscarPorPais(pais: PaisPelicula): Pelicula[] {
...
function demostrarSistemaPeliculas(): void {
    ...
    catalogo.agregarPelicula({
        ...
        pais: PaisPelicula.ESTADOS_UNIDOS,
        anio: 1972,
    ...
    catalogo.agregarPelicula({
        titulo: "Parásitos",
        genero: GeneroPelicula.DRAMA,
        pais: PaisPelicula.COREA_DEL_SUR, 
        anio: 2019,
    ...
    catalogo.agregarPelicula({
        ...
        genero: GeneroPelicula.FANTASIA, // Ahora sí existe este género
    ...
    const peliculasDrama = catalogo.buscarPorGenero(GeneroPelicula.DRAMA);
    ...
    const peliculasFantasia = catalogo.buscarPorGenero(GeneroPelicula.FANTASIA);
    ...
    const peliculasCorea = catalogo.buscarPorPais(PaisPelicula.COREA_DEL_SUR);
    ...
    const peliculasMexico = catalogo.buscarPorPais(PaisPelicula.MEXICO);
